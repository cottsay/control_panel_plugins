...
signals:
    void changeLinearX(const QString &);
    void changeLinearY(const QString &);
    void changeLinearZ(const QString &);
    void changeAngularX(const QString &);
    void changeAngularY(const QString &);
    void changeAngularZ(const QString &);
